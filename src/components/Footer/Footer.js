...
const Footer = () => {
    return (
        ...
        <section className="wave-bg-lotion border-top py-4 py-md-5 py-xl-8">
          <div className="container overflow-hidden">
            <div className="row gy-4 gy-lg-0 justify-content-xl-between">
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                <div className="widget">
                  <a href="#!">
                    <img src={logo} alt="" className="bsb-tpl-logo-footer" />
                  </a>
                </div>
              </div>
              <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                    ...
                    <div className="row gy-4">
                      <div className="col-12">
                        <div className="input-group">
                          ...
                          <input type="email" className="form-control" id="email" value="" placeholder="Email Address" aria-label="email" aria-describedby="email-addon" required />
                        </div>
                      </div>
                      <div className="col-12">
        ...
        <div className="wave-bg-lotion border-top py-4 py-md-5 py-xl-8">
          <div className="container overflow-hidden">
